...
func Router() *mux.Router {
	...
	r.Path("/object/getById").Queries("objectId", "{objectId}").HandlerFunc(controllers.GetObjectById).Methods("GET")
	...
	r.Path("/path/getUserPaths").HandlerFunc(controllers.GetUserPaths).Methods("GET")
